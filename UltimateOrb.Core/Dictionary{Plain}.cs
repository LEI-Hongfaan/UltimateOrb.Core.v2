...
namespace UltimateOrb.Plain.ValueTypes {
    ...
    public partial struct Dictionary<TKey, TValue, TKeyEqualityComparer> :
        Typed.Collections.Generic.IDictionary<TKey, TValue, Dictionary<TKey, TValue, TKeyEqualityComparer>.Enumerator, Dictionary<TKey, TValue, TKeyEqualityComparer>.KeyCollection.Enumerator, Dictionary<TKey, TValue, TKeyEqualityComparer>.KeyCollection, Dictionary<TKey, TValue, TKeyEqualityComparer>.ValueCollection.Enumerator, Dictionary<TKey, TValue, TKeyEqualityComparer>.ValueCollection>,
        IDictionary,
        Typed.Collections.Generic.IReadOnlyDictionary<TKey, TValue, Dictionary<TKey, TValue, TKeyEqualityComparer>.Enumerator, Dictionary<TKey, TValue, TKeyEqualityComparer>.KeyCollection.Enumerator, Dictionary<TKey, TValue, TKeyEqualityComparer>.KeyCollection, Dictionary<TKey, TValue, TKeyEqualityComparer>.ValueCollection.Enumerator, Dictionary<TKey, TValue, TKeyEqualityComparer>.ValueCollection>,
        Typed.Collections.Generic. IDictionaryEx<TKey, TValue, Dictionary<TKey, TValue, TKeyEqualityComparer>.Enumerator, Dictionary<TKey, TValue, TKeyEqualityComparer>.KeyCollection.Enumerator, Dictionary<TKey, TValue, TKeyEqualityComparer>.KeyCollection, Dictionary<TKey, TValue, TKeyEqualityComparer>.ValueCollection.Enumerator, Dictionary<TKey, TValue, TKeyEqualityComparer>.ValueCollection>,
        ...
        System.Collections.Generic.IEnumerable<TValue> System.Collections.Generic.IReadOnlyDictionary<TKey, TValue>.Values {
