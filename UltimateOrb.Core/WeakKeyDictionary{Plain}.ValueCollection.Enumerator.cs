...
namespace UltimateOrb.Plain.ValueTypes {
    ...
    public partial struct WeakKeyDictionary<TKey, TValue, TKeyEqualityComparer>
        ...
        public readonly partial struct ValueCollection {
            ...
            /// <summary>Enumerates the elements of a <see cref="WeakKeyDictionary{TKey,TValue,TEqualityComparer}.ValueCollection" />.</summary>
            ...
            public struct Enumerator : IEnumerator<TValue> {
                ...
                /// <returns>The element in the <see cref="WeakKeyDictionary{TKey,TValue,TEqualityComparer}.ValueCollection" /> at the current position of the enumerator.</returns>
                ...
                /// <summary>Advances the enumerator to the next element of the <see cref="WeakKeyDictionary{TKey,TValue,TEqualityComparer}.ValueCollection" />.</summary>
                ...
                /// <summary>Releases all resources used by the <see cref="WeakKeyDictionary{TKey,TValue,TEqualityComparer}.ValueCollection.Enumerator" />.</summary>
                [MethodImplAttribute(MethodImplOptions.AggressiveInlining)]
                public void Dispose() {
                }
