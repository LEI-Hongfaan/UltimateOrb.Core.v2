        ...
        public partial struct NodeNavigator {
            ...
            public NodeId GetParentId() {
                if (this.ancestor_previous_id_count_collection.TryPeek(out var c)) {
                    var d = this.ancestor_previous_id_count_collection.m_count;
                    var t = d;
                    unchecked {
            ...
            public bool MoveToPreviousSibling() {
                if (this.ancestor_previous_id_count_collection.TryPeek(out var c)) {
                    if (c > 2) {
                        unchecked {
                            --this.ancestor_previous_id_count_collection.m_count;
                        }
                        unchecked {
                            --c;
                        }
            ...
            public bool MoveToParent() {
                if (this.ancestor_previous_id_count_collection.TryPeek(out var c)) {
                    ref var d = ref this.ancestor_previous_id_count_collection.m_count;
                    var t = d;
                    unchecked {
                        t -= unchecked((NodeCount)c);
                    }
            ...
            public bool MoveToRoot() {
                this.ancestor_previous_id_count_collection.m_count = 0;
                this.current_id = RootIndex;
                return true;
            }
