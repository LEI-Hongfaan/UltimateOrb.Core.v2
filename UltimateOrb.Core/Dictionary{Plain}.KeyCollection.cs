...
namespace UltimateOrb.Plain.ValueTypes {
    ...
    public partial struct Dictionary<TKey, TValue, TKeyEqualityComparer> where TKeyEqualityComparer : IEqualityComparer<TKey>, new() {
        ...
        public readonly partial struct KeyCollection
            ...
            /// <summary>
            /// Gets the number of elements contained in the <see cref="Dictionary{TKey,TValue,TEqualityComparer}.KeyCollection"/>.
            /// </summary>
            /// <returns>
            /// The number of elements contained in the <see
            /// cref="Dictionary{TKey,TValue,TEqualityComparer}.KeyCollection"/>. Retrieving the
            /// value of this property is an O(1) operation.
            /// </returns>

            /// <summary>
            /// Initializes a new instance of the <see
            /// cref="Dictionary{TKey,TValue,TEqualityComparer}.KeyCollection"/> class that reflects
            /// the keys in the specified <see cref="Dictionary{TKey,TValue,TEqualityComparer}"/>.
            /// </summary>
            /// <param name="dictionary">
            /// The <see cref="Dictionary{TKey,TValue,TEqualityComparer}"/> whose keys are reflected
            /// in the new <see cref="Dictionary{TKey,TValue,TEqualityComparer}.KeyCollection"/>.
            /// </param>
