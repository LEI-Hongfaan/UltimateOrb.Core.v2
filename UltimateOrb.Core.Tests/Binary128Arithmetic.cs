...
namespace UltimateOrb.Numerics {
    ...
    public static partial class Binary128Arithmetic {
        ...
        public static int GetRawSignFromHi64Bits(UInt64 hi) {
            return unchecked((int)((Int64)hi >> (64 - 1)));
        }
        ...
        internal static UInt64 PropagateNaN(UInt64 value_lo, UInt64 value_hi, out UInt64 result_hi) {
            return (result_hi = /*0x0000800000000000u |*/ value_hi).Comma(value_lo);
        }

        internal static UInt64 PropagateNaN(UInt64 first_lo, UInt64 first_hi, UInt64 second_lo, UInt64 second_hi, out UInt64 result_hi) {
        ...
        public static UInt64 GetBitsFromRawPartsWithRounding(UInt64 fraction_cy, UInt64 fraction_lo, UInt64 fraction_hi, int exponent, int sign, FloatingPointRounding rounding, out UInt64 result_hi) {
            ...
            if (cy) {
                ...
                if (0 == (fraction_hi | fraction_lo)) exponent = 0;
            }
        L_1:;
                ...
                if (0x402F <= exponent) {
                    ...
                    if (exponent < 0x3FFF) {
                        ...
                        case FloatingPointRounding.ToNearestWithMidpointToEven:
                            if (0 == (GetRawFractionHiFromHi64Bits(value_hi) | value_lo)) break;
                        ...
                        case FloatingPointRounding.ToNearestWithMidpointAwayFromZero:
                            if (exponent == 0x3FFE) hi |= 0x3FFF000000000000u;
                            break;
                        case FloatingPointRounding.Downward:
                            if (0 != hi) hi = 0xBFFF000000000000u;
                            break;
                        case FloatingPointRounding.Upward:
                            if (0 == hi) hi = 0x3FFF000000000000u;
                            break;
        ...
        L_DefaultNaN:;
            return GetDefaultNaN(out result_hi);
        }
        */
        ...
        static UInt64 GetBitsFromRawPartsWithNormalizationAndRounding(UInt64 fraction_lo, UInt64 fraction_hi, int exponent, int sign, FloatingPointRounding rounding, out UInt64 result_hi) {
            ...
            if (0 <= shift_count) {
                ...
                sigExtra = Binary128Arithmetic.ShiftRightWithJammingPartial(0, fraction_lo, fraction_hi, unchecked(-shift_count), out fraction_lo, out fraction_hi);
            }
            return Binary128Arithmetic.GetBitsFromRawPartsWithRounding(sigExtra, fraction_lo, fraction_hi, exponent, sign, rounding, out result_hi);

        }

        [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        public static UInt64 GetDefaultNaN(out UInt64 result_hi) {
        ...
        internal static UInt64 AddAbsoluteValuesThenCopySign(UInt64 first_lo, UInt64 first_hi, UInt64 second_lo, UInt64 second_hi, int sign, FloatingPointRounding rounding, out UInt64 result_hi) {
            ...
            if (0 == de) {
                if (first_e == 0x7FFF) {
                    if (0 != (first_f_hi | first_f_lo | second_f_hi | second_f_lo)) goto L_NaN;
                    result_hi = first_hi;
                    return first_lo;
                }
            ...
            if (de < 0) {
                if (second_e == 0x7FFF) {
                    if (0 != (second_f_hi | second_f_lo)) goto L_NaN;
        ...
        newlyAligned:;
            ...
            if (result_f_hi < 0x0002000000000000u) goto roundAndPack;
            unchecked {
                ++result_e;
            }
        shiftRight1:;
        ...
        L_NaN:;
            return Binary128Arithmetic.PropagateNaN(first_lo, first_hi, second_lo, second_hi, out result_hi);
        }
        ...
        internal static UInt64 SubtractAbsoluteValuesThenCopySign(UInt64 first_lo, UInt64 first_hi, UInt64 second_lo, UInt64 second_hi, int sign, FloatingPointRounding rounding, out UInt64 result_hi) {
            ...
            if (0 < de) goto first_eBigger;
            if (de < 0) goto second_eBigger;
            if (first_e == 0x7FFF) {
                if (0 != (first_f_hi | first_f_lo | second_f_hi | second_f_lo)) goto L_NaN;
                // inf - inf
                return Binary128Arithmetic.GetDefaultNaN(out result_hi);
            }
            result_e = first_e;
            if (0 == result_e) result_e = 1;
            if (second_f_hi < first_f_hi) goto aBigger;
            if (first_f_hi < second_f_hi) goto bBigger;
            if (second_f_lo < first_f_lo) goto aBigger;
            if (first_f_lo < second_f_lo) goto bBigger;
        ...
        second_eBigger:;
            ...
            if (0 != first_e) {
                ...
                if (0 == de) goto newlyAlignedBBigger;
            }
        ...
        first_eBigger:;
            ...
            if (0 != second_e) {
                ...
                if (0 == de) goto newlyAlignedABigger;
            }
        ...
        public static UInt64 Divide(UInt64 first_lo, UInt64 first_hi, UInt64 second_lo, UInt64 second_hi, FloatingPointRounding rounding, out UInt64 result_hi) {
            ...
            if (first_e == 0x7FFF) {
                if (0 != (first_f_hi | first_lo)) goto L_NaN;
                if (second_e == 0x7FFF) {
                    if (0 != (second_f_hi | second_lo)) goto L_NaN;
                    goto L_DefaultNaN;
                }
                goto L_Infinity;
            }
            ...
            if (0 == second_e) {
                if (0 == (second_f_hi | second_lo)) {
                    if (0 == (unchecked((uint)first_e) | (first_f_hi | first_lo))) goto L_DefaultNaN;
                    goto L_Infinity;
                }
                second_e = GetShiftedSignificandFromSubnormalRawFraction(second_lo, second_f_hi, out second_lo, out second_f_hi);
            }
            if (0 == first_e) {
                if (0 == (first_f_hi | first_lo)) goto L_Zero;
                first_e = GetShiftedSignificandFromSubnormalRawFraction(first_lo, first_f_hi, out first_lo, out first_f_hi);
            }
            ...
            var rem_lo = first_lo;
            var rem_hi = first_f_hi;
            if (DoubleArithmetic.LessThan(first_lo, first_f_hi, second_lo, second_f_hi)) {
                unchecked {
                    --result_e;
                }
                rem_lo = DoubleArithmetic.ShiftLeft(first_lo, first_f_hi, out rem_hi);
            }
            ...
            for (; ; ) {
                var qL = unchecked((UInt64)(UInt32)(rem_hi >> 19) * recip32);
                ...
                rem_lo = ShiftLeftPartial(rem_lo, rem_hi, 29, out rem_hi);
                term_lo = DoubleArithmetic.MultiplyUnchecked(second_lo, second_f_hi, q, 0u, out term_hi);
                rem_lo = DoubleArithmetic.SubtractUnchecked(rem_lo, rem_hi, term_lo, term_hi, out rem_hi);

                if (0 > unchecked((Int64)rem_hi)) {
                    unchecked {
                        --q;
                    }
                    rem_lo = DoubleArithmetic.AddUnchecked(rem_lo, rem_hi, second_lo, second_f_hi, out rem_hi);
                }
                qs[i] = q;
            }
            ...
            if (2 > (7 & unchecked(1 + q))) {
                ...
                if (0 > unchecked((Int64)rem_hi)) {
                    ...
                    rem_lo = DoubleArithmetic.AddUnchecked(rem_lo, rem_hi, second_lo, second_f_hi, out rem_hi);
                } else if (DoubleArithmetic.LessThanOrEqual(second_lo, second_f_hi, rem_lo, rem_hi)) {
                    unchecked {
                        ++q;
                    }
                    rem_lo = DoubleArithmetic.SubtractUnchecked(rem_lo, rem_hi, second_lo, second_f_hi, out rem_hi);
                }
                if (0 != (rem_hi | rem_lo)) {
                    q |= 1;
                }
            ...
            term_lo = ShiftLeftPartial((UInt64)qs[1], 0u, 54, out term_hi);
            {
                var result_f_lo = DoubleArithmetic.AddUnchecked(unchecked(((UInt64)qs[0] << 25) + (q >> 4)), (UInt64)qs[2] << 19, term_lo, term_hi, out var result_f_hi);
        ...
        L_NaN:;
            return PropagateNaN(first_lo, first_hi, second_lo, second_hi, out result_hi);
        }
            ...
            unchecked {
                ...
                if (value_e == 0x7FFF) {
                    if (0 != (value_f_hi | value_lo)) {
                        return PropagateNaN(value_lo, value_hi, out result_hi);
                    }
                    if (0 == value_s) return (result_hi = value_hi).Comma(value_lo);
                    goto L_NaN;
                }

                if (0 != value_s) {
                    if (0 == ((uint)value_e | value_f_hi | value_lo)) return (result_hi = value_hi).Comma(value_lo); ;
                    goto L_NaN;
                }

                if (0 == value_e) {
                    if (0 == (value_f_hi | value_lo)) return (result_hi = value_hi).Comma(value_lo);
                ...
                // sig32Z <= sqrt(sig32A) <= sqrt(sigA)
                var significand32 = (UInt32)(value_f_hi >> 17);
                var rSqrt32 = ReciprocalSqrt32(value_e, significand32);
                ...
                for (; ; ) {
                    ...
                    if (/* LIKELY */0 == (remainder_hi & 0x8000000000000000u)) break;
                    --r;
                ...
                if ((r & 0xF) <= 2) {
                    ...
                    // s_hi @ s_lo @ s_lo : negative remainder
                    if (0 > (Int64)s_hi) {
                        result_f_cy |= 1;
                    } else {
                        if (0 != (s_hi | s_lo | t_lo)) {
        ...
        private static UInt32 ReciprocalSqrt32(int oddExponent, UInt32 value) {
            unchecked {
        ...
        [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        public static int NormalizeSubnormal(UInt64 value_lo, UInt64 value_hi, out UInt64 result_lo, out UInt64 result_hi) {
            unchecked {
                if (0 == value_hi) {
