...
namespace UltimateOrb.Core.Tests {
    ...
    public static partial class TestModule {
        ...
        public static Quadruple Quadruple_Sqrt_A(Quadruple x) {
            return pppp.Sqrt(x);
        }

        public static IEnumerable<Quadruple> Quadruple_Sqrt_A(IEnumerable<Quadruple> ps) {
            return pppp.Sqrt(ps);
        }
        ...
        public static bool Test_DoubleArithmetic_DivRem_A_F_1(UInt64 x, UInt64 y) {
            ...
            var q0 = Internal.System.Math.DivRem(x, y, out var r0);
        ...
        public static bool Test_Quadruple_Sqrt_20000(IEnumerable<Quadruple> ps) {
            var r0 = Quadruple_Sqrt_A(ps);
            var r1 = ps.Select(p => Quadruple.Math.Sqrt(p));
        ...
        public static bool Test_Quadruple_Sqrt_4() {
            return Test_Quadruple_Sqrt_20000(GetQuadrupleTestSamples(2, 2));
        }
        ...
        static IEnumerable<double> GetDoubleTestSamples(int e, int f) {
            var es = GetUInt64PermutationsLEC(11, e);
            var fs = GetUInt64PermutationsLEC(52, f);
        ...
        static IEnumerable<Quadruple> GetQuadrupleTestSamples(int e, int f) {
            var es = GetUInt128PermutationsLEC(15, e);
            var fs = GetUInt128PermutationsLEC(112, f);
            foreach (var fi in fs) {
                foreach (var ei in es) {
        ...
        public unsafe ref struct UInt256Builder {
            ...
            public static void DivRem(in UInt256Builder lhs, in UInt256Builder rhs, out UInt256Builder quo, out UInt256Builder rem) {
                ...
                if ((lhsLength == 1) && (rhsLength == 1)) {
                    uint quotient = Internal.System.Math.DivRem(lhs._blocks[0], rhs._blocks[0], out uint remainder);
                ...
                if (0 == (rhs.GetDigit(1) | rhs.GetDigit(2) | rhs.GetDigit(3))/* rhsLength == 1 */) {
                    ...
                    for (int i = quoLength - 1; i >= 0; i--) {
                        ...
                        ulong digit = Internal.System.Math.DivRem(value, rhsValue, out carry);
